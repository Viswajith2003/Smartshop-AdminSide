...
const AdminLogin = () => {
  ...
  const {
    ...
    defaultValues: { email: "admin@smartshop.com", password: "admin123" },
  });
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
      <div className="w-full max-w-4xl flex flex-col md:flex-row bg-white rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(79,70,229,0.15)] min-h-[600px]">
        ...
        <div className="w-full md:w-[45%] bg-indigo-600 p-8 md:p-12 flex flex-col items-center justify-center text-center text-white relative overflow-hidden">
          ...
          <h2 className="text-4xl font-black mb-4 tracking-tight uppercase relative z-10">
            Admin Portal
          </h2>
          <p className="text-indigo-100 font-bold uppercase tracking-widest text-xs opacity-80 relative z-10">
        ...
        <div className="w-full md:w-[55%] p-8 md:p-16 flex flex-col justify-center bg-white">
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="text-indigo-600 font-semibold text-xs mt-2">
              Seeded demo account: admin@smartshop.com / admin123
            </p>
          </div>
